...
#Declaring Variables:
metric="memory_percent" #Disponible Metrics: cpu_percent, memory_percent, io_consumption_percent, storage_percent, storage_used, storage_limit, serverlog_storage_percent, serverlog_storage_usage, serverlog_storage_limit, active_connections, connections_failed, seconds_behind_master, backup_storage_used, network_bytes_egress, network_bytes_ingress
...
#take note: in some cases the URI above might be diferent depending on which resource you're trying to use. in most of cases this might work. if it doesn't search for the URI in Azure Docs and exchange the variables as your needs.

#####Author: Gabriel C. Lacanna
###Title: MEMORY PERCENTAGE METRICS FOR AZURE RESOURCES
